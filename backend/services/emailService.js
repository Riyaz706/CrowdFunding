        ...
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <div style="margin-top: 30px;">
                    <a href="${process.env.CLIENT_URL}/campaigns" style="background: #000; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Explore Projects</a>
                </div>
            </div>
        `,
    };
    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <div style="margin-top: 30px;">
                    <a href="${process.env.CLIENT_URL}/donor-tracking" style="background: #000; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">View Dashboard</a>
                </div>
            </div>
        `,
    };
